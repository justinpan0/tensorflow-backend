...
with open('config.json') as json_data_file:
    ...
    #print(data["config"]["output"]["saved_model_dir"])
    saved_model_dir = data["config"]["output"]["saved_model_dir"]
    output_dir = data["config"]["output"]["output_dir"]
    output_node_names = data["config"]["output"]["output_node_names"]
...
class CNN:
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            # Saving
            tf.saved_model.simple_save(sess, saved_model_dir, inputs={"x":X}, outputs={"y":y})
            tfjs.converters.convert_tf_saved_model(saved_model_dir,
                                                    output_node_names,
                                                    output_dir,
